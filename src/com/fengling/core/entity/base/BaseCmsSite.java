...
public abstract class BaseCmsSite  implements Serializable {
	...
	public BaseCmsSite (
		...
		com.fengling.core.entity.CmsConfig config,
	...
	// many to one
	private com.fengling.core.entity.Ftp uploadFtp;
	private com.fengling.core.entity.CmsConfig config;
	// one to one
	private com.fengling.core.entity.CmsSiteCompany siteCompany;
	 ...
	 */
	public com.fengling.core.entity.Ftp getUploadFtp () {
		return uploadFtp;
	}
	 ...
	 */
	public void setUploadFtp (com.fengling.core.entity.Ftp uploadFtp) {
	 ...
	 */
	public com.fengling.core.entity.CmsConfig getConfig () {
		return config;
	}
	 ...
	 */
	public void setConfig (com.fengling.core.entity.CmsConfig config) {
		this.config = config;
	}
	
	public com.fengling.core.entity.CmsSiteCompany getSiteCompany() {
		return siteCompany;
	}

	public void setSiteCompany(com.fengling.core.entity.CmsSiteCompany siteCompany) {
	...
	public void setUserSites(
			java.util.Set<com.fengling.core.entity.CmsUserSite> userSites) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.fengling.core.entity.CmsSite)) return false;
		else {
			com.fengling.core.entity.CmsSite cmsSite = (com.fengling.core.entity.CmsSite) obj;
