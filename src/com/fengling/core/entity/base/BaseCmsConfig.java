...
public abstract class BaseCmsConfig  implements Serializable {
	...
	// components
	 ...
	 com.fengling.core.entity.EmailConfig m_emailConfig;
	...
	public com.fengling.core.entity.MarkConfig getMarkConfig () {
		return m_markConfig;
	}
	 ...
	 */
	public void setMarkConfig (com.fengling.core.entity.MarkConfig m_markConfig) {
		this.m_markConfig = m_markConfig;
	}


	public com.fengling.core.entity.EmailConfig getEmailConfig () {
	 ...
	 */
	public void setEmailConfig (com.fengling.core.entity.EmailConfig m_emailConfig) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.fengling.core.entity.CmsConfig)) return false;
		else {
			com.fengling.core.entity.CmsConfig cmsConfig = (com.fengling.core.entity.CmsConfig) obj;
