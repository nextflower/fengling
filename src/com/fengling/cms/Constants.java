...
public class Constants {
	 ...
	 * 数据库备份文本前缀
	 */
	public static String ONESQL_PREFIX="fengling_BACKUP_";
	/**
	 * 防火墙配置文件
	 */
	 ...
	 * 配置文件
	 */
	public static String fengling_CONFIG = "/WEB-INF/config/fengling/fengling.properties";
	/**
	 * 插件路径
	 */
	 ...
	 * 模板路径
	 */
	public static final String TPL_BACK_BASE = "/WEB-INF/fengling_sys";
}
