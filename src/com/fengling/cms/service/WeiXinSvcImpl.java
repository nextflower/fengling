...
import com.fengling.common.upload.FileUpload;
import com.fengling.common.util.PropertyUtils;
...
import com.fengling.core.manager.CmsConfigMng;
...
public class WeiXinSvcImpl implements WeiXinSvc {
	...
	public String getToken() {
		String tokenGetUrl=PropertyUtils.getPropertyValue(new File(realPathResolver.get(Constants.fengling_CONFIG)),TOKEN_KEY);
	...
	public Set<String> getUsers(String access_token) {
		String usersGetUrl=PropertyUtils.getPropertyValue(new File(realPathResolver.get(Constants.fengling_CONFIG)),USERS_KEY);
	...
	public String  uploadFile(String access_token,String filePath,String type){
		String sendGetUrl=PropertyUtils.getPropertyValue(new File(realPathResolver.get(Constants.fengling_CONFIG)),UPLOAD_KEY);
	...
	public void sendText(String access_token,String content) {
		String sendGetUrl=PropertyUtils.getPropertyValue(new File(realPathResolver.get(Constants.fengling_CONFIG)),SEND_KEY);
        String url = sendGetUrl+"?access_token=" + access_token;
	...
	public void sendContent(String access_token,String title, String description, String url,
			String picurl) {
		String sendUrl=PropertyUtils.getPropertyValue(new File(realPathResolver.get(Constants.fengling_CONFIG)),SEND_KEY);
