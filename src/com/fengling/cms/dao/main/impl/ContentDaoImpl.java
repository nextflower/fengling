...
import static com.fengling.cms.entity.main.Content.ContentStatus.all;
import static com.fengling.cms.entity.main.Content.ContentStatus.checked;
import static com.fengling.cms.entity.main.Content.ContentStatus.draft;
import static com.fengling.cms.entity.main.Content.ContentStatus.passed;
import static com.fengling.cms.entity.main.Content.ContentStatus.prepared;
import static com.fengling.cms.entity.main.Content.ContentStatus.recycle;
import static com.fengling.cms.entity.main.Content.ContentStatus.rejected;
import static com.fengling.cms.entity.main.Content.ContentStatus.contribute;

import static com.fengling.cms.action.directive.abs.AbstractContentDirective.PARAM_ATTR_START;
import static com.fengling.cms.action.directive.abs.AbstractContentDirective.PARAM_ATTR_END;
import static com.fengling.cms.action.directive.abs.AbstractContentDirective.PARAM_ATTR_LIKE;
import static com.fengling.cms.action.directive.abs.AbstractContentDirective.PARAM_ATTR_EQ;
import static com.fengling.cms.action.directive.abs.AbstractContentDirective.PARAM_ATTR_GT;
import static com.fengling.cms.action.directive.abs.AbstractContentDirective.PARAM_ATTR_GTE;
import static com.fengling.cms.action.directive.abs.AbstractContentDirective.PARAM_ATTR_LT;
import static com.fengling.cms.action.directive.abs.AbstractContentDirective.PARAM_ATTR_LTE;
...
import com.fengling.cms.dao.main.ContentDao;
import com.fengling.cms.entity.main.Content;
import com.fengling.cms.entity.main.ContentCheck;
import com.fengling.cms.entity.main.Content.ContentStatus;
	...
	*/
	...
	public List<Content> getList(Integer[] siteIds, Integer[] channelIds,
		...
		if(rootChannelId != null) {
			f.append(" and bean.rootChannel.id=:rootChannelId");
			f.setParam("rootChannelId", rootChannelId);
		}
		appendOrder(f, orderBy);
