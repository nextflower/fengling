package com.fengling.cms.entity.main.base;
...
public abstract class BaseContent  implements Serializable {
	...
	// one to one
	private com.fengling.cms.entity.main.ContentExt contentExt;
	private com.fengling.cms.entity.main.ContentCount contentCount;

	// many to one
	private com.fengling.cms.entity.main.ContentType type;
	private com.fengling.core.entity.CmsSite site;
	private com.fengling.core.entity.CmsUser user;
	private com.fengling.cms.entity.main.Channel channel;
	private com.fengling.cms.entity.main.Channel rootChannel;
	private com.fengling.cms.entity.main.CmsModel model;

	// collections
	private java.util.Set<com.fengling.cms.entity.main.Channel> channels;
	private java.util.Set<com.fengling.cms.entity.main.CmsTopic> topics;
	private java.util.Set<com.fengling.core.entity.CmsGroup> viewGroups;
	private java.util.List<com.fengling.cms.entity.main.ContentTag> tags;
	private java.util.List<com.fengling.cms.entity.main.ContentPicture> pictures;
	private java.util.List<com.fengling.cms.entity.main.ContentAttachment> attachments;
	private java.util.Set<com.fengling.cms.entity.main.ContentTxt> contentTxtSet;
	private java.util.Set<com.fengling.cms.entity.main.ContentCheck> contentCheckSet;
	private java.util.Map<java.lang.String, java.lang.String> attr;
	private java.util.Set<com.fengling.core.entity.CmsUser> collectUsers;
	private java.util.Set<com.fengling.cms.entity.assist.CmsComment> comments;
	private java.util.Set<com.fengling.cms.entity.assist.CmsFile> files;
	private java.util.Set<com.fengling.cms.entity.assist.CmsJobApply> jobApplys;
	private java.util.Set<com.fengling.cms.entity.assist.CmsScoreRecord> scoreRecordSet;
	...
	public java.util.Set<com.fengling.cms.entity.assist.CmsFile> getFiles() {
		return files;
	}

	public void setFiles(java.util.Set<com.fengling.cms.entity.assist.CmsFile> files) {
		this.files = files;
	}
	
	public java.util.Set<com.fengling.cms.entity.assist.CmsJobApply> getJobApplys() {
			return jobApplys;
	}
	
	public void setJobApplys(
				java.util.Set<com.fengling.cms.entity.assist.CmsJobApply> jobApplys) {
	...
	public java.util.Set<com.fengling.cms.entity.assist.CmsScoreRecord> getScoreRecordSet() {
		return scoreRecordSet;
	}

	public void setScoreRecordSet(
			java.util.Set<com.fengling.cms.entity.assist.CmsScoreRecord> scoreRecordSet) {
	 ...
	 */
	public com.fengling.cms.entity.main.ContentExt getContentExt () {
		return contentExt;
	}
	 ...
	 */
	public void setContentExt (com.fengling.cms.entity.main.ContentExt contentExt) {
	 ...
	 */
	public com.fengling.cms.entity.main.ContentCount getContentCount () {
		return contentCount;
	}
	 ...
	 */
	public void setContentCount (com.fengling.cms.entity.main.ContentCount contentCount) {
	 ...
	 */
	public com.fengling.cms.entity.main.ContentType getType () {
		return type;
	}
	 ...
	 */
	public void setType (com.fengling.cms.entity.main.ContentType type) {
		this.type = type;
	}
	 ...
	 */
	public com.fengling.core.entity.CmsSite getSite () {
		return site;
	}
	 ...
	 */
	public void setSite (com.fengling.core.entity.CmsSite site) {
		this.site = site;
	}
	 ...
	 */
	public com.fengling.core.entity.CmsUser getUser () {
		return user;
	}
	 ...
	 */
	public void setUser (com.fengling.core.entity.CmsUser user) {
		this.user = user;
	}
	 ...
	 */
	public com.fengling.cms.entity.main.Channel getChannel () {
		return channel;
	}
	 ...
	 */
	public void setChannel (com.fengling.cms.entity.main.Channel channel) {
		this.channel = channel;
		if(channel.getParent() != null) {
			setRootChannel(channel.getParent());
		} else {
			setRootChannel(channel);
		}
	}
	
	public com.fengling.cms.entity.main.CmsModel getModel() {
		return model;
	}

	public void setModel(com.fengling.cms.entity.main.CmsModel model) {
		this.model = model;
	}
	 ...
	 */
	public java.util.Set<com.fengling.cms.entity.main.Channel> getChannels () {
		return channels;
	}
	 ...
	 */
	public void setChannels (java.util.Set<com.fengling.cms.entity.main.Channel> channels) {
	 ...
	 */
	public java.util.Set<com.fengling.cms.entity.main.CmsTopic> getTopics () {
		return topics;
	}
	 ...
	 */
	public void setTopics (java.util.Set<com.fengling.cms.entity.main.CmsTopic> topics) {
		this.topics = topics;
	}
	 ...
	 */
	public java.util.Set<com.fengling.core.entity.CmsGroup> getViewGroups () {
		return viewGroups;
	}
	 ...
	 */
	public void setViewGroups (java.util.Set<com.fengling.core.entity.CmsGroup> viewGroups) {
	 ...
	 */
	public java.util.List<com.fengling.cms.entity.main.ContentTag> getTags () {
		return tags;
	}
	 ...
	 */
	public void setTags (java.util.List<com.fengling.cms.entity.main.ContentTag> tags) {
		this.tags = tags;
	}
	 ...
	 */
	public java.util.List<com.fengling.cms.entity.main.ContentPicture> getPictures () {
		return pictures;
	}
	 ...
	 */
	public void setPictures (java.util.List<com.fengling.cms.entity.main.ContentPicture> pictures) {
	 ...
	 */
	public java.util.List<com.fengling.cms.entity.main.ContentAttachment> getAttachments () {
		return attachments;
	}
	 ...
	 */
	public void setAttachments (java.util.List<com.fengling.cms.entity.main.ContentAttachment> attachments) {
	 ...
	 */
	public java.util.Set<com.fengling.cms.entity.main.ContentTxt> getContentTxtSet () {
	 ...
	 */
	public void setContentTxtSet (java.util.Set<com.fengling.cms.entity.main.ContentTxt> contentTxtSet) {
	 ...
	 */
	public java.util.Set<com.fengling.cms.entity.main.ContentCheck> getContentCheckSet () {
	 ...
	 */
	public void setContentCheckSet (java.util.Set<com.fengling.cms.entity.main.ContentCheck> contentCheckSet) {
	...
	public java.util.Set<com.fengling.core.entity.CmsUser> getCollectUsers() {
		return collectUsers;
	}

	public void setCollectUsers(
			java.util.Set<com.fengling.core.entity.CmsUser> collectUsers) {
		this.collectUsers = collectUsers;
	}
	

	public java.util.Set<com.fengling.cms.entity.assist.CmsComment> getComments() {
		return comments;
	}

	public void setComments(
			java.util.Set<com.fengling.cms.entity.assist.CmsComment> comments) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.fengling.cms.entity.main.Content)) return false;
		else {
			com.fengling.cms.entity.main.Content content = (com.fengling.cms.entity.main.Content) obj;
	...
	public void setRootChannel(com.fengling.cms.entity.main.Channel rootChannel) {
		this.rootChannel = rootChannel;
	}

	public com.fengling.cms.entity.main.Channel getRootChannel() {
		return rootChannel;
	}
