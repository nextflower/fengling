...
public abstract class BaseContentCheck  implements Serializable {
	...
	private com.fengling.core.entity.CmsUser reviewer;
	...
	public com.fengling.core.entity.CmsUser getReviewer() {
		return reviewer;
	}

	public void setReviewer(com.fengling.core.entity.CmsUser reviewer) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.fengling.cms.entity.main.ContentCheck)) return false;
		else {
			com.fengling.cms.entity.main.ContentCheck contentCheck = (com.fengling.cms.entity.main.ContentCheck) obj;
