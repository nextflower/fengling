...
public abstract class BaseChannel  implements Serializable {
	...
	public BaseChannel (
		...
		com.fengling.cms.entity.main.CmsModel model,
	...
	// one to one
	private com.fengling.cms.entity.main.ChannelExt channelExt;
	private com.fengling.cms.entity.main.ChannelCount channelCount;

	// many to one
	private com.fengling.core.entity.CmsSite site;
	private com.fengling.cms.entity.main.CmsModel model;
	private com.fengling.cms.entity.main.Channel parent;

	// collections
	private java.util.Set<com.fengling.cms.entity.main.Channel> child;
	private java.util.Set<com.fengling.core.entity.CmsGroup> viewGroups;
	private java.util.Set<com.fengling.core.entity.CmsGroup> contriGroups;
	private java.util.Set<com.fengling.core.entity.CmsUser> users;
	private java.util.Set<com.fengling.cms.entity.main.ChannelTxt> channelTxtSet;
	private java.util.List<com.fengling.cms.entity.main.ChannelModel> channelModels;
	 ...
	 */
	public com.fengling.cms.entity.main.ChannelExt getChannelExt () {
		return channelExt;
	}
	 ...
	 */
	public void setChannelExt (com.fengling.cms.entity.main.ChannelExt channelExt) {
		this.channelExt = channelExt;
	}
	
	public com.fengling.cms.entity.main.ChannelCount getChannelCount() {
		return channelCount;
	}

	public void setChannelCount(com.fengling.cms.entity.main.ChannelCount channelCount) {
	 ...
	 */
	public com.fengling.cms.entity.main.Channel getParent () {
		return parent;
	}
	 ...
	 */
	public void setParent (com.fengling.cms.entity.main.Channel parent) {
		this.parent = parent;
	}
	 ...
	 */
	public java.util.Set<com.fengling.cms.entity.main.Channel> getChild () {
		return child;
	}
	 ...
	 */
	public void setChild (java.util.Set<com.fengling.cms.entity.main.Channel> child) {
		this.child = child;
	}
	 ...
	 */
	public java.util.Set<com.fengling.core.entity.CmsGroup> getContriGroups () {
		return contriGroups;
	}
	 ...
	 */
	public void setContriGroups (java.util.Set<com.fengling.core.entity.CmsGroup> contriGroups) {
	 ...
	 */
	public java.util.Set<com.fengling.core.entity.CmsUser> getUsers () {
		return users;
	}
	 ...
	 */
	public void setUsers (java.util.Set<com.fengling.core.entity.CmsUser> users) {
		this.users = users;
	}
	/**
	 * Return the value associated with the column: channelTxtSet
	 */
	public java.util.Set<com.fengling.cms.entity.main.ChannelTxt> getChannelTxtSet () {
	 ...
	 */
	public void setChannelTxtSet (java.util.Set<com.fengling.cms.entity.main.ChannelTxt> channelTxtSet) {
		this.channelTxtSet = channelTxtSet;
	}

	public java.util.List<com.fengling.cms.entity.main.ChannelModel> getChannelModels() {
		return channelModels;
	}

	public void setChannelModels(
			java.util.List<com.fengling.cms.entity.main.ChannelModel> channelModels) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.fengling.cms.entity.main.Channel)) return false;
		else {
			com.fengling.cms.entity.main.Channel channel = (com.fengling.cms.entity.main.Channel) obj;
