...
import com.fengling.cms.entity.main.base.BaseChannel;
import com.fengling.cms.staticpage.StaticPageUtils;
import com.fengling.common.hibernate3.HibernateTree;
import com.fengling.common.hibernate3.PriorityComparator;
import com.fengling.common.hibernate3.PriorityInterface;
...
//			return getUrlDynamic(null);
	...
	public Channel(java.lang.Integer id,
			...
			com.fengling.cms.entity.main.CmsModel model, java.lang.Integer lft,
