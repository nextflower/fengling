...
public abstract class BaseCmsCommentExt  implements Serializable {
	...
	// one to one
	private com.fengling.cms.entity.assist.CmsComment comment;
	 ...
	 */
	public com.fengling.cms.entity.assist.CmsComment getComment () {
		return comment;
	}
	 ...
	 */
	public void setComment (com.fengling.cms.entity.assist.CmsComment comment) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.fengling.cms.entity.assist.CmsCommentExt)) return false;
		else {
			com.fengling.cms.entity.assist.CmsCommentExt cmsCommentExt = (com.fengling.cms.entity.assist.CmsCommentExt) obj;
