...
public abstract class BaseCmsVoteItem  implements Serializable {
	...
	// many to one
	private com.fengling.cms.entity.assist.CmsVoteTopic topic;
	private com.fengling.cms.entity.assist.CmsVoteSubTopic subTopic;
	 ...
	 */
	public com.fengling.cms.entity.assist.CmsVoteTopic getTopic () {
		return topic;
	}
	 ...
	 */
	public void setTopic (com.fengling.cms.entity.assist.CmsVoteTopic topic) {
		this.topic = topic;
	}
	

	public com.fengling.cms.entity.assist.CmsVoteSubTopic getSubTopic() {
		return subTopic;
	}

	public void setSubTopic(com.fengling.cms.entity.assist.CmsVoteSubTopic subTopic) {
		this.subTopic = subTopic;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.fengling.cms.entity.assist.CmsVoteItem)) return false;
		else {
			com.fengling.cms.entity.assist.CmsVoteItem cmsVoteItem = (com.fengling.cms.entity.assist.CmsVoteItem) obj;
