...
public abstract class BaseCmsScoreRecord  implements Serializable {
	...
	// many to one
	private com.fengling.cms.entity.assist.CmsScoreItem item;
	 ...
	 */
	public com.fengling.cms.entity.assist.CmsScoreItem getItem () {
		return item;
	}
	 ...
	 */
	public void setItem (com.fengling.cms.entity.assist.CmsScoreItem item) {
		this.item = item;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.fengling.cms.entity.assist.CmsScoreRecord)) return false;
		else {
			com.fengling.cms.entity.assist.CmsScoreRecord cmsScoreRecord = (com.fengling.cms.entity.assist.CmsScoreRecord) obj;
