...
public abstract class BaseCmsGuestbook  implements Serializable {
	...
	public BaseCmsGuestbook (
		...
		com.fengling.cms.entity.assist.CmsGuestbookCtg ctg,
		java.lang.String ip,
	...
	// one to one
	private com.fengling.cms.entity.assist.CmsGuestbookExt ext;

	// many to one
	private com.fengling.core.entity.CmsUser member;
	private com.fengling.core.entity.CmsUser admin;
	private com.fengling.core.entity.CmsSite site;
	private com.fengling.cms.entity.assist.CmsGuestbookCtg ctg;
	 ...
	 */
	public com.fengling.cms.entity.assist.CmsGuestbookExt getExt () {
		return ext;
	}
	 ...
	 */
	public void setExt (com.fengling.cms.entity.assist.CmsGuestbookExt ext) {
		this.ext = ext;
	}
	 ...
	 */
	public com.fengling.core.entity.CmsUser getMember () {
		return member;
	}
	 ...
	 */
	public void setMember (com.fengling.core.entity.CmsUser member) {
		this.member = member;
	}
	 ...
	 */
	public com.fengling.core.entity.CmsUser getAdmin () {
		return admin;
	}
	 ...
	 */
	public void setAdmin (com.fengling.core.entity.CmsUser admin) {
		this.admin = admin;
	}
	 ...
	 */
	public com.fengling.cms.entity.assist.CmsGuestbookCtg getCtg () {
		return ctg;
	}
	 ...
	 */
	public void setCtg (com.fengling.cms.entity.assist.CmsGuestbookCtg ctg) {
		this.ctg = ctg;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.fengling.cms.entity.assist.CmsGuestbook)) return false;
		else {
			com.fengling.cms.entity.assist.CmsGuestbook cmsGuestbook = (com.fengling.cms.entity.assist.CmsGuestbook) obj;
