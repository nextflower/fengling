...
public abstract class BaseCmsSiteFlow  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.fengling.cms.entity.assist.CmsSiteFlow)) return false;
		else {
			com.fengling.cms.entity.assist.CmsSiteFlow cmsSiteFlow = (com.fengling.cms.entity.assist.CmsSiteFlow) obj;
